...
@Component({
  selector: 'app-group-coin-add',
  templateUrl: 'group-coin-add.component.html',
  styleUrls: ['group-coin-add.component.css']
})
export class GroupCoinAddComponent implements OnInit {
